#利用 alexnet对图像进行分类预测并绘制直方图
using TyDeepLearning
using TyImages
weights = "imagenet"
network = alexnet(weights)
numclasses = 1000
...
I = TyImages.imresize(image, [227 227])
...
f = open("/home/tongyuan/桌面/TyDeepLearning/data/imagenet/imagenet_classes.txt")
