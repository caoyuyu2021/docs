...
@testset "load.jl" begin
    ...
    file3 = joinpath(pkgdir(TyDeepLearning), "test/Images/TrainNetworkTest/net.ckpt")
    ...
    trainNetwork(train_data, train_label, layers, options)
    net = TyDeepLearning.save(layers, file3)
    TyDeepLearning.load(file3; net=layers)
