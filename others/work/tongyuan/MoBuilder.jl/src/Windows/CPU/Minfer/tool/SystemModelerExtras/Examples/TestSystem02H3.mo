within SystemModelerExtras.Examples;
...
1：3 根部力 4：6根部力矩 ", 
  ...
  NeuralNet.Components.MIMO_Net mIMO_Net
    annotation (Placement(transformation(origin = {-1.6225905463474568, -7.8475322283609685}, 
      extent = {{-28.82205033763045, -28.49753222836096}, {28.822050337630454, 28.49753222836096}})));
equation 
  connect(realExpression.y, mIMO_Net.a[1])
    annotation (Line(origin = {-81.0, 21.0}, 
      points = {{-45.0, 29.0}, {34.0, 29.0}, {34.0, -29.0}, {45.0, -29.0}}, 
      color = {0, 0, 127}));
  connect(realExpression1.y, mIMO_Net.a[2])
    annotation (Line(origin = {-81.0, 2.0}, 
      points = {{-45.0, 9.0}, {34.0, 9.0}, {34.0, -10.0}, {45.0, -10.0}}, 
      color = {0, 0, 127}));
  connect(realExpression3.y, mIMO_Net.a[3])
    annotation (Line(origin = {-81.0, -50.0}, 
      points = {{-45.0, -42.0}, {-45.0, -22.0}, {34.0, -22.0}, {34.0, 42.0}, {45.0, 42.0}}, 
      color = {0, 0, 127}));
  connect(realExpression4.y, mIMO_Net.a[4])
    annotation (Line(origin = {-54.0, -50.0}, 
      points = {{-19.0, -42.0}, {7.0, -42.0}, {7.0, 42.0}, {18.0, 42.0}}, 
      color = {0, 0, 127}));
end TestSystem02H3;