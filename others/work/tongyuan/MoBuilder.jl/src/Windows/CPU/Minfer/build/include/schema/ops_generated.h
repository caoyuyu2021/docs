...
enum PrimitiveType : uint8_t {
  ...
  PrimitiveType_MAX = PrimitiveType_TensorScatterAdd
};

inline const PrimitiveType (&EnumValuesPrimitiveType())[214] {
...
inline const char * const *EnumNamesPrimitiveType() {
  static const char * const names[215] = {
    "NONE",
    "Abs",
    "Activation",
    "ActivationGrad",
...
inline const char *EnumNamePrimitiveType(PrimitiveType e) {
  if (flatbuffers::IsOutRange(e, PrimitiveType_NONE, PrimitiveType_TensorScatterAdd)) return "";
