...
model System1 "伺服翼系统——不带电机驱动"
  ...
  Modelica.Mechanics.MultiBody.Forces.WorldForce force
    annotation (Placement(transformation(origin = {40.0, -54.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Blocks.Sources.RealExpression realExpression[3]
    annotation (Placement(transformation(origin = {-3.999999999999999, -54.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
equation 
  ...
  connect(foldingRope.drive1, revolute.axis)
    annotation (Line(origin = {70.0, 22.0}, 
      ...
      color = {0, 0, 0}));
  connect(force.frame_b, telescopicWing.frame_b)
    annotation (Line(origin = {55.0, -33.0}, 
      points = {{-5.0, -21.0}, {5.0, -21.0}, {5.0, 21.0}, {-5.0, 21.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(realExpression.y, force.force)
    annotation (Line(origin = {18.0, -54.0}, 
