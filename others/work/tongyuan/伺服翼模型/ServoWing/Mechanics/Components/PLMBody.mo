...
model PLMBody "平面刚体"
  ...
  Interfaces.Planar.Frame_a frame_a annotation (Placement(transformation(extent = {{-116, -16}, {-84, 16}})));
  ...
  parameter Boolean enableGravity = true
    "= true, if gravity effects should be taken into account" annotation (
      ...
      HideResult = true, 
      choices(checkBox = true));
  input Modelica.Mechanics.MultiBody.Types.Color sphereColor = Modelica.Mechanics.MultiBody.Types.Defaults.BodyColor "Color of sphere" 
