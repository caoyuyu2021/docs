...
model ExternalSpurgear_EJ "直齿外啮合齿轮考虑效率、惯量"
  ...
  ServoWing.Mechanics.Components.ExternalSpurgearSingle externalSpurgear(m = m, Alpha = Alpha, z = zA, CoefficientOfHa = CoefficientOfHaA, CoefficientOfC = CoefficientOfCA)
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia1(J = JA)
    annotation (Placement(transformation(origin = {-50.0, 50.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  ServoWing.Mechanics.Components.Efficiency efficiency1
