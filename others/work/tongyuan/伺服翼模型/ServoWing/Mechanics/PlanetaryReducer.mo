...
model PlanetaryReducer "行星减速器"
  ...
  //变量
  Real ratio;
  Mechanics.Components.ExternalSpurgearSingle externalSpurgearDriven(
  ...
  Interfaces.RotationalInterfaces.Flange_b flange_b
    annotation (Placement(transformation(origin = {100.0, 0.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Mechanics.Components.InternalSpurgearSingle internalSpurgear(m = m, Alpha = Alpha, z = zC, CoefficientOfHa = CoefficientOfHaC, CoefficientOfC = CoefficientOfCC)
    annotation (Placement(transformation(origin = {40.0, 30.0}, 
      extent = {{10.0, -10.0}, {-10.0, 10.0}})));
  Modelica.Mechanics.Rotational.Components.Fixed fixed
    annotation (Placement(transformation(origin = {70.0, 22.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Mechanics.Components.PlanetNGW planetG(zA = zA, zC = zC) annotation (Placement(transformation(origin = {-8.000000000000004, 8.0}, 
