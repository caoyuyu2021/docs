...
model TelescopicWingFlex "伸缩翼"
  ...
  annotation (Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
    ...
    fileName = "modelica://ServoWing/Pictures/伸缩翼柔性体.svg")}), 
    Diagram(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
      grid = {2.0, 2.0}), graphics = {Text(origin = {-44.0, -67.0}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "1025", 
      textStyle = {TextStyle.None}), Rectangle(origin = {-20.999999999999996, -67.0}, 
      fillColor = {255, 255, 255}, 
      extent = {{-31.000000000000004, 33.0}, {31.000000000000004, -33.0}}), Text(origin = {0.0, -67.0}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "1026", 
      textStyle = {TextStyle.None}), Text(origin = {-22.0, -40.0}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "220", 
      textStyle = {TextStyle.None}), Text(origin = {-22.0, -67.0}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "933", 
      textStyle = {TextStyle.None}), Text(origin = {-17.0, -114.0}, 
      lineColor = {0, 0, 0}, 
      extent = {{-15.0, 5.0}, {15.0, -5.0}}, 
      textString = "节点位置", 
      textStyle = {TextStyle.None}, 
      textColor = {0, 0, 0}, 
      horizontalAlignment = LinePattern.None), Text(origin = {-82.99999999999999, -100.00000000000001}, 
      lineColor = {0, 0, 0}, 
      extent = {{-3.000000000000014, 2.999999999999986}, {3.0, -2.999999999999986}}, 
      textString = "Y", 
      textStyle = {TextStyle.None}, 
      textColor = {0, 0, 0}, 
      horizontalAlignment = LinePattern.None), Line(origin = {-66.0, -115.0}, 
      points = {{-11.0, 0.0}, {11.0, 0.0}}, 
      arrow = {Arrow.None, Arrow.Filled}), Line(origin = {-77.0, -106.0}, 
      points = {{0.0, -9.0}, {0.0, 9.0}}, 
      arrow = {Arrow.None, Arrow.Filled}), Text(origin = {-50.0, -113.0}, 
      lineColor = {0, 0, 0}, 
  ...
  FlexBody.Components.ModalBody_TR modalBody_TR(clampedNodes = {1025, 1026, 220, 933}, cmNodes = {933}, cm_Nodes_factor = {1}, 
    N_MODAL_MNF = 12, 
    str_mnf_name = "200")
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_1026(length = 0.2)
    annotation (Placement(transformation(origin = {74.0, -27.99999999999997}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_220(length = 0.2)
    annotation (Placement(transformation(origin = {74.0, -63.99999999999996}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_933(length = 0.2)
