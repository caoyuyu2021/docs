...
model Test_ServoWing1
  ...
  MainBody mainBody
    annotation (Placement(transformation(origin = {-50.0, -12.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  TelescopicWing telescopicWing
    annotation (Placement(transformation(origin = {40.0, -12.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  FoldingWings foldingWings
    annotation (Placement(transformation(origin = {114.0, -12.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  ...
  annotation (Diagram(coordinateSystem(extent = {{-180.0, -100.0}, {180.0, 120.0}}, 
    grid = {2.0, 2.0})), 
    experiment(Algorithm = Dassl, Interval = 0.02, StartTime = 0, StopTime = 10, Tolerance = 0.0001));
  ...
  Modelica.Mechanics.Rotational.Sources.Position position1
    annotation (Placement(transformation(origin = {-70.0, 24.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Mechanics.TelescopicRope telescopicRope annotation (Placement(transformation(origin = {-30.0, 24.0}, 
    extent = {{-10.0, -10.0}, {10.0, 10.0}})));
