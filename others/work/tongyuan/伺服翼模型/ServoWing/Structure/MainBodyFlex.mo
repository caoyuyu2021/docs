...
model MainBodyFlex "固定翼"
  ...
  annotation (Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
    ...
    fileName = "modelica://ServoWing/Pictures/固定翼柔性体.svg")}), 
    Diagram(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
      grid = {2.0, 2.0}), graphics = {Polygon(origin = {-16.0, -64.99999999999997}, 
      fillColor = {255, 255, 255}, 
      fillPattern = FillPattern.Solid, 
      points = {{-46.0, 51.0}, {-46.0, -51.0}, {46.0, -51.0}, {46.0, 21.0}}), Text(origin = {-52.0, -69.99999999999997}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "1025", 
      textStyle = {TextStyle.None}), Text(origin = {-31.0, -69.99999999999997}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "1026", 
      textStyle = {TextStyle.None}), Text(origin = {-14.0, -33.99999999999997}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "164", 
      textStyle = {TextStyle.None}), Text(origin = {-14.0, -75.99999999999997}, 
      extent = {{-10.0, 4.0}, {10.0, -4.0}}, 
      textString = "723", 
      textStyle = {TextStyle.None}), Text(origin = {-19.0, -126.99999999999997}, 
      lineColor = {0, 0, 0}, 
      extent = {{-15.0, 5.0}, {15.0, -5.0}}, 
      textString = "节点位置", 
      textStyle = {TextStyle.None}, 
      textColor = {0, 0, 0}, 
      horizontalAlignment = LinePattern.None), Text(origin = {-85.0, -112.99999999999999}, 
      lineColor = {0, 0, 0}, 
      extent = {{-3.000000000000014, 2.999999999999986}, {3.0, -2.999999999999986}}, 
      textString = "Y", 
      textStyle = {TextStyle.None}, 
      textColor = {0, 0, 0}, 
      horizontalAlignment = LinePattern.None), Line(origin = {-68.0, -127.99999999999997}, 
      points = {{-11.0, 0.0}, {11.0, 0.0}}, 
      arrow = {Arrow.None, Arrow.Filled}), Line(origin = {-79.0, -118.99999999999997}, 
      points = {{0.0, -9.0}, {0.0, 9.0}}, 
      arrow = {Arrow.None, Arrow.Filled}), Text(origin = {-52.0, -125.99999999999997}, 
      lineColor = {0, 0, 0}, 
  ...
  FlexBody.Components.ModalBody_TR modalBody_TR(clampedNodes = {1025, 1026, 164, 723}, 
    N_MODAL_MNF = 12, 
    cmNodes = {723}, cm_Nodes_factor = {1})
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_1026(length = 0.2)
    annotation (Placement(transformation(origin = {74.0, -27.99999999999997}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_164(length = 0.2)
    annotation (Placement(transformation(origin = {74.0, -63.99999999999996}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame_723(length = 0.2)
...
equation 
  connect(frame_a, modalBody_TR.frame_ref)
    annotation (Line(origin = {-54.0, 0.0}, 
      ...
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(modalBody_TR.nodes_clamped[2], frame_b)
  ...
  connect(force.frame_b, modalBody_TR.nodes_clamped[4])
    annotation (Line(origin = {26.0, 19.0}, 
      points = {{-2.0, 19.0}, {14.0, 19.0}, {14.0, -19.0}, {-14.0, -19.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(force1.frame_b, modalBody_TR.nodes_clamped[3])
    annotation (Line(origin = {28.0, 31.0}, 
      points = {{-4.0, 31.0}, {16.0, 31.0}, {16.0, -31.0}, {-16.0, -31.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(modalBody_TR.nodes_clamped[2], fixedFrame_1026.frame_a)
    annotation (Line(origin = {38.0, -14.0}, 
      points = {{-26.0, 14.0}, {-6.0, 14.0}, {-6.0, -14.0}, {26.0, -14.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(modalBody_TR.nodes_clamped[3], fixedFrame_164.frame_a)
    annotation (Line(origin = {38.0, -32.0}, 
      points = {{-26.0, 32.0}, {-6.0, 32.0}, {-6.0, -32.0}, {26.0, -32.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
  connect(modalBody_TR.nodes_clamped[4], fixedFrame_723.frame_a)
    annotation (Line(origin = {38.0, -46.0}, 
      points = {{-26.0, 46.0}, {-6.0, 46.0}, {-6.0, -46.0}, {26.0, -46.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
end MainBodyFlex;